   ...
   <div class="col-xs-12 content pb-4">
      <div class="row">
       ...
       if(isset($_SESSION['login'])){
              ?>
                   <p class="alert alert-success">Produit ajouté</p>
                    <div class="container">
                           ...
                           <h4 class=" d-none d-md-block col-md-5">Prix htva (21%)</h4>
                            ...
                            <?php
                              include 'header.php';
                                ...
                                $nom = $_POST['nom'];
                                $prix = $_POST['prix'];
                                $requete = "INSERT INTO `produits`(`nom`, `prix`, `cat_id`) VALUES ('$nom','$prix','$catid')";
                                $bdd->exec($requete);
                                $reponse = $bdd->prepare('SELECT * FROM produits WHERE cat_id = :id');
