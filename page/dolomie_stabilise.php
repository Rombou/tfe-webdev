...
<head>
    ...
    <title>Gravissime - Dolomie stabilisée</title>
               ...
               <div class="container">
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Dolomie stabilisée</li>
                      </ol>
                </nav>
                    ...
                    <table class="table table-light table-hover">
                       <thead class="table-secondary">
                        ...
                        <tbody>
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produits WHERE cat_id=10');
                                $proid=$donnees['proid'];
                ...
                <div class="d-xs-block d-sm-none">
                   <table class="table table-light table-striped">
                    ...
                    <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produit WHERE cat_id=7');
                                $proid=$donnees['proid'];
                                while ($donnees = $reponse->fetch())
                                {
                                    ?>
