        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-10 col-sm-9 mt-2">
               <div class="container">
                ...
                <div class="col-sm-8 col-lg-6 mx-auto mt-2 mb-4">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src="../assets/image/produits/calcaire_0-6.jpg">
                            <legend class="text-center pt-1 pb-4 bg-light">Gravier 0/6</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/calcaire_2-6.jpg">
                          <legend class="text-center pt-1 pb-4 bg-light">Gravier 2/6</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/calcaire_6-14.jpg" >
                          <legend class="text-center pt-1 pb-4 bg-light">Gravier 6/14</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/calcaire_6-20.jpg" >
                          <legend class="text-center pt-1 pb-4 bg-light">Gravier 6/20</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/calcaire_20-30.jpg" >
                          <legend class="text-center pt-1 pb-4 bg-light">Gravier 20/30</legend>
                        </div>
                      </div>
                    </div>
                </div>
                    ...
                    <table class="table table-light table-hover">
                       <thead class="table-secondary">
                        ...
                        <tbody>
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produits WHERE cat_id=1');
                                $proid=$donnees['proid'];
