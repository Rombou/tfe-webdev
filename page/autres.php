                    ...
                    <table class="table table-light table-hover">
                       <thead class="table-secondary">
                        ...
                        <tbody>
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produits WHERE cat_id=11');
                                $proid=$donnees['proid'];
                ...
                <div class="d-xs-block d-sm-none">
                    <table class="table table-light table-striped">
                        <tbody>
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produit WHERE cat_id=8');
                                $proid=$donnees['proid'];
                                while ($donnees = $reponse->fetch())
                                {
                                    ?>
                                           ...
                                           <form action="panier.php?action=ajout&amp;l&amp;q&amp;p" method="post">
                                               ...
                                               <div class="container">
                                                <p class="form-group row text-center">
                                                    ...
                                                    <input class="form-control col-3 text-center" type='submit' value='+'>
                                               </p> 
                                               </div>
                                            </form>
                                              </table>
