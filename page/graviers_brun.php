                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          ...
                          <legend class="text-center pt-1 pb-4">Shiste rouge 0/6</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/shiste_rouge.jpg">
                          <legend class="text-center pt-1 pb-4">Shiste rouge 5/15</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/pinky.jpg" >
                          <legend class="text-center pt-1 pb-4">Pinky</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/cachemire.jpg" >
                          <legend class="text-center pt-1 pb-4">Cachemire</legend>
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="../assets/image/produits/romance.jpg" >
                          <legend class="text-center pt-1 pb-4">Romance</legend>
                        </div>
                      </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                       <thead class="bg-light">
                        ...
                        <tbody>
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produit WHERE cat_id=1 and typ_id=3');
                                $proid=$donnees['proid'];
