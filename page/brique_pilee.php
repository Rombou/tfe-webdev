...
<head>
    ...
    <title>Gravissime - Brique pilée</title>
               ...
               <div class="container">
                    ...
                    <table class="table table-light table-hover">
                       <thead class="table-secondary">
                        ...
                        <tbody>
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produits WHERE cat_id=8');
                                $proid=$donnees['proid'];
                ...
                <div class="d-xs-block d-sm-none">
                   <table class="table table-secondary table-striped">
                    ...
                    <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produit WHERE cat_id=4');
                                $proid=$donnees['proid'];
                                while ($donnees = $reponse->fetch())
                                {
                                    ?>
