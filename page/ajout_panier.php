            ...
            else
            {
                ...
                <div class="container">
                        <div class="text-center">
                            <a href="../produit.php" class="btn btn-light mx-1" title="Ajouter d'autre produit">
                                <span class="d-xs-block d-sm-none"><i class="fas fa-plus"></i></span>
                                <span class="d-none d-sm-block">Produit</span>
                            </a>
                            <a href="panier.php" class="btn btn-light mx-1" title="Aller au pannier">
