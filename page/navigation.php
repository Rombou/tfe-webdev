...
<div class="d-none d-lg-block">
    <nav class="nav-link">
            <ul class="nav" role="navigation">
                ...
                <li class="col-sm-12 mb-4"><a href="connexion_enregistrement.php">S'inscrire</a></li>
    ...
    <div class="container">
       <div class="col-xs-12 my-2">
        ...
        <div class="col-sm-12 row">
            <button class="btn row btn-light" onclick="location.href='panier.php'" style="cursor: pointer"><img src="../assets/image/panier.png" width="20"><span class="text-center position-absolute rounded-circle bg-light border border-secondary ml-4 p1 px-2" ><?php
...
<div class="btn-group d-sm-none d-xs-block row">
    <div class="container">
       <div class="col-xs-12 my-2">
           ...
           <button class="btn btn-light" onclick="location.href='panier.php'" style="cursor: pointer"><img src="../assets/image/panier.png" width="20"><span class="text-center position-absolute rounded-circle bg-light border border-secondary p1 px-2" ><?php
            include 'nombrepanier.php';?></span></button>
        </div>
    </div>
</div>  