               ...
               <div class="container">
                ...
                <div class="mt-2 mb-3">
                   <?php
                    $email = $_POST['email'];   
                   ?>
                    <form action="mail_update.php" method="post" class="needs-validation" name="login_perdu" novalidate>
                        <fieldset class="col-12">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-8 col-lg-9" >
                                        <input name="email" value="<?=$email;?>" aria-describedby="emailHelp" type="email" class="form-control" id="colFormLabel" required>
