...
$email   = htmlentities($_POST["email"]);
    ...
    $contenu .= '<a href="https://gravissime.biz/page/connexion_enregistrement.php" style="padding : 0.5em; border : 1pt solid #C2C2C2; background: #ECECEC; border-radius : 1em; color #333; width: 30%;">Continuer </a>';
