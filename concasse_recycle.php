...
<head>
    ...
    <title>Gravissime - Concassés de recyclés</title>
               ...
               <div class="container">
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Concassés de recyclés</li>
                      </ol>
                    </nav>
                    <div class="container">
                        <div class="table-secondary row col-12 py-2">
                            ...
                            <?php
                              include 'header.php';
                                $reponse = $bdd->query('SELECT proid,nom,prix FROM produits WHERE cat_id=6');
                            ...
                            <form action="ajout_panier.php?action=ajout&amp;l&amp;q&amp;p" method="post">
                                <div class='bg-light col-12 border-bottom py-1 row'>
                                    ...
                                    <div class="col-md-2"><span class="d-md-none d-sm-block mt-1"><h4>Quantité</h4> </span>
